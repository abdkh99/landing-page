...
const WhyUS = () => {
  ...
  return (
    <div
      data-aos="fade-up"
      className=" relative flex flex-col mx-auto w-full min-h-screen h-[120vh] bg-white "
    >
      <div className="box bg-[#fff] shadow-2xl rounded-3xl absolute top-[-25vh] 2xl:top-[-20vh] translate-x-[-50%] left-1/2 xl:w-[70%] w-[90%] h-[50vh] min-h-fit max-960:hidden">
        ...
        <div className="box flex flex-1 justify-between">
          <div data-aos="fade-up" className="box-content  max-lg:p-5 p-10 xl:p-20 flex-1 max-w-[20rem]">
          ...
          <div  data-aos="fade-up" data-aos-delay="100" className="box-content max-lg:p-5 p-10  flex-1 max-w-[20rem] xl:p-20 xl:pb-0">
            <div className="text-2xl text-MainBlue ">
          ...
          <div  data-aos="fade-up" data-aos-delay="200" className="box-content max-lg:p-5 p-10  flex-1 max-w-[20rem] xl:p-20 xl:pb-0">
            <div className="text-2xl text-MainBlue ">
        ...
        <div className="text-center ">
          ...
          <div className="max-w-6xl mx-auto py-8 px-4 space-y-6">
            ...
            <div data-aos="fade-up"  className="bg-white rounded-2xl p-6 shadow">
              <h3 data-os-delay="300" className="text-xl font-bold mb-2">Summary</h3>
              <p data-aos="fade-up" data-aos-delay="100" className="text-gray-600 mb-4">
                $1,876,580
