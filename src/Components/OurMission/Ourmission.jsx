  ...
  return (
    <>
      <div className="w-full h-full bg-[#eee]">
        <div className="max-w-6xl mx-auto pt-8 px-10 bg-[#eee] h-fit min-h-[110vh] w-full space-y-6">
          <div className="container mx-auto items-center flex flex-col justify-center  w-full h-full">
            ...
            >
              ...
              <div className="flex items-center justify-end gap-4 flex-1 ">
                <button className="border p-4 rounded-xl border-MainBlue text-white bg-MainBlue hover:bg-cyan-800 transition-all">
                  Get Started Now
                </button>
                <button className="border p-4 rounded-xl border-[#000021] drop-shadow-2xl shadow-2xl hover:bg-[#082c44] text-white">
                  Learn More
                </button>
              </div>
            </div>
