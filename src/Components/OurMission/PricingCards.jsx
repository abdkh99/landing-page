...
import plusBg from "/public/assets/image.png"; // تأكد من أن الصورة موجودة في المسار الصحيح
  ...
  return (
    <div className="flex flex-col max-sm:text-center max-sm:items-center  md:flex-row gap-6  w-full max-w-4xl mx-auto p-4">
      ...
      <label data-aos="fade-up" className="flex-1 cursor-pointer w-[25rem]">
        ...
        <div
          style={{
            backgroundImage: `url(${plusBg})`,
            backgroundPosition: "center",
            backgroundSize: "cover",
            backgroundRepeat: "no-repeat",
          }}
          className="relative h-40 rounded-xl p-6 text-slate-800 shadow-2xl peer-checked:ring-2 peer-checked:ring-blue-500 transition duration-30 peer-checked:text-white max-sm:w-full "
        >
      ...
      >
        <input type="radio" name="plan" className="peer hidden" />
        <div
          className="relative  z-10 h-40 rounded-xl bg-cover bg-center p-6 text-white  shadow-2xl peer-checked:ring-2 peer-checked:ring-blue-500 transition duration-300 bg-SecBlue peer-checked:bg-MainBlue peer-checked:text-white"
          style={{
