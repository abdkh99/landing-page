...
const Hero = () => {
  return (
    <>
      <div className="Hero-Page w-full  mt-10 bg-MainWhite min-h-[100vh] grid grid-cols-2 max-960:grid-cols-1  max-960:items-center max-960:flex max-960:flex-col  max-440:translate-x-0  max-440:p-0  overflow-hidden max-440:mt-8 max-440:">
        <div className="card Left-conten  min-1400:ml-24 relative flex mt-24 max-960:mt-0  flex-col  h-full pl-14 max-440:pl-0 ">
          ...
          b text-white h-full rounded-lg ml-[-1rem] px-4 py-2 flex items-center"
              >
                Get Started
                <FontAwesomeIcon
                  className="max-sm:pl-0 rotate-45 pl-1"
                  icon={faArrowUp}
                />
              </button>
            </div>
